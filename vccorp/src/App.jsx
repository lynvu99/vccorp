    ...
    <div className="app-wrapper bg-center bg-no-repeat bg-contain relative">
      ...
      <div className="h-full relative text-white rounded-lg overflow-hidden shadow-lg">
        <div className=" desktop flex">
          <div className="description h-120 lg:h-120  md:h-120 sm:h-100 w-full md:w-1/2 lg:w-2/5 flex flex-col justify-center absolute inset-y-0 right-0 md:right-8 lg:right-40 xl:right-100 md:right-8 sm:right-0 lg:top-48 md:top-52 sm:top-64 z-10">
            <p className="fs-28">
